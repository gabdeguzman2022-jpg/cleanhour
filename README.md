...
![CleanHour screenshot](screenshot.jpg)
...
| Region | Source |
|---|---|
| Great Britain | National Grid ESO (free, keyless, official real-time and 48h forecast) |
...
- Real-world data quirks handled honestly rather than papered over: EIA's ~27h publish lag means near-term accuracy stats correctly show "n/a" instead of a fabricated number, and SMARD's per-fuel reporting lag is detected and filtered so a partially-reported hour never skews the mix.
